...
class _PatientDetailsScreenState extends State<PatientDetailsScreen> {
  ...
  Future<void> _loadPatientData() async {
    try {
      // Fetch patient data from users table
      final patientData = await PatientService.getPatientById(widget.patientId);

      if (patientData != null) {
        setState(() {
          _patientName = patientData['name'] ?? widget.patientName;
          _patientEmail = patientData['email'] ?? '';
          _patientPhone = patientData['phone'] ?? '';
        });
      } else {
        // Fallback to widget.patientName if patient not found
        setState(() {
          _patientName = widget.patientName;
          _patientEmail = '';
          _patientPhone = '';
      ...
      // On error, use provided patient name
      setState(() {
        _patientName = widget.patientName;
        _patientEmail = '';
        _patientPhone = '';
