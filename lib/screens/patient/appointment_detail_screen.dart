                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Date & Time: ${DateFormat('EEEE, MMMM dd, yyyy').format(appointment.appointment_date)} at ${appointment.time}',
                  ...
                  if (appointment.status == AppointmentStatus.completed) ...[
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () async {
                          final result = await context.push(
                            '/patient/rate-doctor?doctorId=${appointment.doctorId}&doctorName=${Uri.encodeComponent(appointment.doctorName)}&appointmentId=${appointment.id}',
                          );
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        onPressed: () {
                          context.go(
                              '/patient/reviews/${appointment.doctorId}?doctorName=${Uri.encodeComponent(appointment.doctorName)}');
                        },
