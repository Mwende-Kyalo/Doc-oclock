...
class _MessagesScreenState extends State<MessagesScreen> {
  ...
  Future<void> _loadChatPreviews() async {
    ...
    try {
      ...
      final chatPreviews =
          await MessageService.getChatPreviews(authProvider.user!.id, isDoctor: false);
      setState(() {
  ...
  Widget _buildChatPreviewCard(ChatPreviewModel chat) {
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () {
          context.push(
              '/patient/chat/${chat.chatId}?doctorName=${Uri.encodeComponent(chat.doctorName)}&doctorId=${chat.doctorId}');
        },
      ),
    );
  }
