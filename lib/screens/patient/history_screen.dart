          ...
          children: [
            TabBar(
              ...
              tabs: [
                ...
                Tab(text: l10n.pastCalls, icon: const Icon(Icons.call)),
              ],
            ),
            Expanded(
              child: TabBarView(
  ...
  Widget _buildPastAppointmentCard(AppointmentModel appointment) {
    ...
    switch (appointment.status) {
      ...
      default:
        ...
        statusText = l10n.pastAppointments;
        break;
    }
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () => context.go('/patient/appointment/${appointment.id}'),
        child: Padding(
          padding: const EdgeInsets.all(16),
          child: Column(
              ...
              if (appointment.paymentMade) ...[
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    Text(
                      '${l10n.paid}: KES ${appointment.consultationFee.toStringAsFixed(2)}',
                      style: const TextStyle(
